...
-- to a specific parser combinator library, rendering our use of @parsers@
-- pointless. Now we solely rely on 'CharParsing' (from @parsers@) and leave
-- what to do with that fact up to the call site.
